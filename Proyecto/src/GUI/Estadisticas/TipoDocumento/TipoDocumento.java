...
public class TipoDocumento {
    ...
    public TipoDocumento(int s,int m,int l, int xl,
            int xxl)throws FileNotFoundException {
        
        this.atras = new Button("Atras");
        ObservableList<PieChart.Data> pieChartData
                = FXCollections.observableArrayList(
                        new PieChart.Data("Terjeta de identidad", s),
                        new PieChart.Data("Cedula de ciudadania", m),
                        new PieChart.Data("Cedula de extranjeria", l),
                        new PieChart.Data("Pasaporte", xl),
                        new PieChart.Data("Registro civil", xxl));
        final PieChart chart = new PieChart(pieChartData);
        chart.setTitle("Relacion tipo de documento en la base de datos");
